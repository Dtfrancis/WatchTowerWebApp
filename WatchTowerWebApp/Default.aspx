<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WatchTowerWebApp._Default" %>
            ...
            <div class="col-sm-4 mb-4 mb-sm-0">           
                <div class="card" align="center">                
                    ...
                    <div class="card-body">
                        ...
                        <asp:Button ID="toApplePage" runat="server" Text="Explore" class="btn btn-primary" OnClick="toApplePage_Click" />
                    </div>
                </div>            
            </div>
